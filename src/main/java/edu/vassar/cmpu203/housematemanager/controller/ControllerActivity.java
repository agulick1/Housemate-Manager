...
public class ControllerActivity extends AppCompatActivity implements IHomeView.Listener,
    ...
    //TODO prevent login screen skip
    @Override
    ...
    public void onViewPastReceipts() {
        PastReceiptsFragment pastReceiptsView = new PastReceiptsFragment(this, this.receiptManager);
        this.mainView.displayFragment(pastReceiptsView);
        pastReceiptsView.updateDisplay(receiptManager);
    }
