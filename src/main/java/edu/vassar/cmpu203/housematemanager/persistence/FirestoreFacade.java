...
public class FirestoreFacade implements IPersistenceFacade {
    ...
    @Override
    public void retrieveInventory(InventoryListener listener) {
    ...
    @Override
    public void retrieveChoreManager(ChoreManagerListener ChoreManager) {
    ...
    @Override
    public void retrieveReceiptManager(ReceiptManagerListener ReceiptManager) {
