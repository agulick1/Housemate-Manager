...
public interface IPersistenceFacade {
    ...
    void retrieveInventory(InventoryListener listener);

    // retrieveHouse is already being used for authentication
//    void saveHousemate(Housemate housemate);
//    void retrieveHouse(HouseListener listener);

    void saveChore(Chore chore);
    void retrieveChoreManager(ChoreManagerListener ChoreManager);

    void saveReceipt(Receipt receipt);
    void retrieveReceiptManager(ReceiptManagerListener ReceiptManager);
